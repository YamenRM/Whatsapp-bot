...
def build_conversational_rag_chain():
    ...
    system_prompt = (
        ...
        "استخدم الفقرات المسترجعة التالية فقط للإجابة على سؤال المستخدم بدقة عالية .\n"
        "إذا لم تكن الإجابة موجودة بشكل واضح في الفقرات المسترجعة أعلاه، حاول تقديم أقرب معلومة متاحة بشكل مفيد، وإذا لم يوجد أي شيء ذو صلة على الإطلاق فقط قل بلطف: 'عذراً، ليس لدي علم دقيق بهذه المعلومة حالياً، سأقوم بتحويلك للموظف المختص لمساعدتك.' دون اختراع أي تفاصيل.\n"
